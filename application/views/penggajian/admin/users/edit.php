            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card card-primary">
                        <div class="card-body">
                            <form action="<?= base_url('admin/users/edit/' . $user['username']) ?>" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" name="nama" value="<?= set_value('nama', $user['nama']) ?>">
                                    <?= form_error('nama', '<div class="text-danger text-small">', '</div>') ?>
                                </div>

                                <div class="form-group">
                                    <label>Alamat</label>
                                    <textarea class="form-control" name="alamat" id="alamat" cols="40" rows="40"><?= set_value('alamat', $user['alamat']) ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else :  ?>
                                        <div class="text-small">*isi jika ingin diganti</div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>No. HP</label>
                                    <input type="text" class="form-control" name="no_hp" value="<?= set_value('no_hp', $user['no_hp']) ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="role_id" id="role_id" class="form-control col-4">
                                        ...
                                        <?php foreach ($allRole as $ar) : ?>
                                            <option <?= set_value('role_id', $user['role_id']) == $ar['id'] ? 'selected' : '' ?> value="<?= $ar['id'] ?>"> <?= $ar['nama_role'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jk" id="jk" class="form-control col-6">
                                        ...
                                        <option <?= set_value('jk', $user['jk']) == 'L' ? 'selected' : '' ?> value="L">Laki-laki</option>
                                        <option <?= set_value('jk', $user['jk']) == 'P' ? 'selected' : '' ?> value="P">Perempuan</option>
                                    </select>
